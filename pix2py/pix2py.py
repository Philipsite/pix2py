...
class PixelMap:
    def __init__(self, pixelmap_dir="_pixelmaps", endmember_dict=None):
        ...
        Args:
            ...
            Endmember name should be taken form the database used to generate the pixelmaps. For pure phases, the phase name from the database should be provided as single endmember name.
